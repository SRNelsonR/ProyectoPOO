<?php
    include_once("class_presentacion.php");
...
<head>
    ...
    <title>Farmacia MaxUtil | Presentaciones </title>
        ...
        <!--  page-wrapper -->
          <div id="page-wrapper">
            <div class="row">
                 <!-- page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Registro de Tipos de Presentacion</h1>
                </div>
                <!--end page header -->
            </div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Datos del Tipo de Presentacion
                        </div>
                                ...
                                <div class="col-lg-6">
                                    <form role="form">
                                        <div class="form-group">
                                            ...
                                            <?php
                                            Presentaciones::obtenerCodigo($conexion);
                                            ?>
                                        </div>
                                        <div class="form-group">
                                            <label>Nombre:</label>
                                            <input class="form-control" placeholder="Escriba el Nombre del Cliente">
                                        </div>
                                        <div class="form-group">
