...
<head>
    ...
    <title>Farmacia MaxUtil | Laboratorios</title>
        ...
        <!--  page-wrapper -->
          <div id="page-wrapper">
            <div class="row">
                 <!-- page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Registro de Laboratorios</h1>
                </div>
                <!--end page header -->
            </div>
            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <form role="form">
                                        <div class="form-group">
                                            ...
                                            <?php 
                                            Laboratorio::obtenerCodigo($conexion);
                                            ?>
                                        </div>
                                        <div class="form-group">
                                            <label>Nombre:</label>
                                            <input class="form-control" placeholder="Escriba el Nombre del Laboratorio">
                                        </div>
                                        <div class="form-group">
                                            <label>Direccion:</label>
                                            <input class="form-control" placeholder="Escriba la Direccion del Laboratorio">
                                        </div>
                                        <div class="form-group">
                                            <label>Telefono:</label>
                                            <input class="form-control" placeholder="Escriba el Telefono del Laboratorio">
                                        </div>
                                        <div class="form-group">
                                            <label>Correo Electrónico:</label>
                                            <input class="form-control" placeholder="Escriba el correo del Laboratorio">
                                        </div>
                                        <div class="form-group">
