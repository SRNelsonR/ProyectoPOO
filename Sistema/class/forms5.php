...
<head>
    ...
    <title>Farmacia MaxUtil | Dolencias</title>
        ...
        <!--  page-wrapper -->
          <div id="page-wrapper">
            <div class="row">
                 <!-- page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Registro de las Dolencias</h1>
                </div>
                <!--end page header -->
            </div>
            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <form role="form">
                                        <div class="form-group">
                                            <label>Codigo Dolencia:</label>
                                            <?php
                                            Dolencia::obtenerCodigo($conexion);
                                            ?>
                                        </div>
                                        <div class="form-group">
                                            <label>Nombre:</label>
                                            <input class="form-control" placeholder="Escriba el Nombre de la Dolencia">
                                        </div>
