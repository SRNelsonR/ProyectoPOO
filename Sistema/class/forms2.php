...
<?php
    ...
    include_once("class_profesion.php");
    include_once("class_TipoContrato.php");
    include_once("class_Jornada.php");
...
<head>
    ...
    <title>Farmacia MaxUtil | Empleado </title>
                                ...
                                <div class="col-lg-6">
                                    <form role="form">
                                        <div class="form-group">
                                            ...
                                            <?php
                                            Empleado::obtenerCodigo($conexion);
                                            ?>
                                        </div>
                                        <div class="form-group">
                                            <label>Nombre:</label>
                                            <input class="form-control" placeholder="Escriba el Nombre del Empleado">
                                        </div>
                                        <div class="form-group">
                                            <label>Apellido:</label>
                                            <input class="form-control" placeholder="Escriba el Apellido del Empleado">
                                        </div>
                                        <div class="form-group">
                                            <label>Edad:</label>
                                            <input class="form-control" placeholder="Escriba la Edad del Empleado">
                                        </div>
                                        <div class="form-group">
                                            <label>N° Identificacion:</label>
                                            <input class="form-control" placeholder="Escriba el Numero de Identificacion del Empleado">
                                        </div>
                                        <div class="form-group">
                                            <label>Domicilio:</label>
                                            <input class="form-control" placeholder="Escriba el Domicilio del Empleado">
                                        </div>
                                        <div class="form-group">
                                            <label>Telefono:</label>
                                            <input class="form-control" placeholder="Escriba el Telefono del Empleado">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Escriba el correo del Empleado">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php
                                            Profesion::generarListaProfesiones($conexion);
                                            ?>
                                        </div>
                                        <div class="form-group">
                                            <label>Tipo Contrato:</label>
                                            <?php
                                            TipoContrato::generarListaTipoContratos($conexion);
                                            ?>
                                        </div>
                                        <div class="form-group">
                                            <label>Jornada:</label>
                                           <?php
                                            Jornada::generarListaJornadas($conexion);
                                            ?>
                                        </div>
                                        <div class="form-group">
                                            <label>Jefe Superior:</label>
                                            <?php
                                            Empleado::generarListaEmpleados($conexion);
                                            ?>                                            
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php
                                            Sucursal::generarListaSucursales($conexion);
                                            ?>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>Usuario:</label>
                                            <input class="form-control" placeholder="Escriba el usuario del Empleado">
                                        </div>
                                        <div class="form-group">
                                            <label>Contraseña:</label>
                                            <input class="form-control" type="password" placeholder="Escriba la contraseña del Empleado">
                                        </div>
                                         <div class="form-group">
                                            <label>Añadir Referencia:</label>
                                            <input class="form-control" placeholder="Escriba una Referencia">
                                        </div>
                                        <div class="form-group">
