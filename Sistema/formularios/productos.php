...
<html>
                    ...
                    <div id="myCarousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                          ...
                          <div class="item active">
                            <img src="../img/medicamento1.jpg" alt="Chania" width="460" height="345">
                          ...
                          <div class="item">
                            <img src="../img/medicamento2.png" alt="Chania" width="460" height="345">
                            <div class="carousel-caption">
                          ...
                          <div class="item">
                            <img src="../img/medicamento3.jpg" alt="Flower" width="460" height="345">
                            <div class="carousel-caption">
                          ...
                          <div class="item">
                            <img src="../img/medicamento4.jpg" alt="Flower" width="460" height="345">
                            <div class="carousel-caption">
            ...
            <h1><br>Productos</h1>
             ...
             <div class="row">
                ...
                <div  class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
                    <div class="well">
                        <div class="bg-info">
                            <img src="../img/medicamento2.png" class="img-responsive">
                            <b>NEUROBION DC 25000 HYPAK CON 1 JERINGA</b><br>
                            <span class="label label-primary">3</span>
                            <span class="glyphicon glyphicon-star" aria-hidden="true"></span>
                            <br>
                ...
                <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
                    <div class="well">
                        <div class="bg-info">
                            <img src="../img/medicamento3.jpg" class="img-responsive">
                            <b>NEUROBION DC 25000 HYPAK CON 1 JERINGA</b><br>
                            <span class="label label-primary">3</span>
                            <span class="glyphicon glyphicon-star" aria-hidden="true"></span>
                            <br>
                            ...
                            VITAMINA B6 (PIRIDOXINA)    100 MG
                            VITAMINA B12 (CIANOCOBALAMINA, HIDROXOCOBALAMINA)   25000 MCG<br><br><br>
                        </div>
                    </div>
                </div>
                <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
                    <div class="well">
                        <div class="bg-info">
                            <img src="../img/medicamento4.jpg" class="img-responsive">
                ...
                <div class="col-xs-6 col-sm-6 col-md-4 col-lg-">
                    <div class="well">
                        <div class="bg-info">
                            <img src="../img/medicamento5.jpg" class="img-responsive">
    ...
    <br><br><br><br><br>
        ...
        <!--<script src="../js/controlador_productos.js"></script>-->
    </body>
</html>