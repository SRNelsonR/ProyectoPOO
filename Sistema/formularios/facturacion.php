...
<html>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-2">
            <input type="text" class="form-control" name="book[0].title" placeholder="Codigo" />
        </div>
        <div class="col-xs-4">
            <input type="text" class="form-control" name="book[0].isbn" placeholder="Nombre" />
        </div>
        <div class="col-xs-2">
            <input type="text" class="form-control" name="book[0].price" placeholder="Precio" />
        </div>
        <div class="col-xs-1">
    ...
    <div class="form-group hide" id="bookTemplate">
        <div class="col-xs-2 col-xs-offset-1">
            <input type="text" class="form-control" name="title" placeholder="Codigo" />
        </div>
        <div class="col-xs-4">
            <input type="text" class="form-control" name="isbn" placeholder="Nombre" />
        </div>
        <div class="col-xs-2">
